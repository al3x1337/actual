(function() {
  ...
  const messageGenerator = define_process_env_default$d.NODE_ENV === "production" ? fallback : generatorFunction;
  ...
  const finalAssertExports = define_process_env_default$c.NODE_ENV === "production" ? null : {
    hasMethod,
    isArray,
    isInstance,
    isOneOf,
  ...
  const logger = define_process_env_default$b.NODE_ENV === "production" ? null : (() => {
  ...
  class Strategy {
    ...
    async _getResponse(handler, request, event) {
      ...
      try {
        ...
        if (!response) {
          throw error;
        } else if (define_process_env_default$8.NODE_ENV !== "production") {
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  const fileList = /* @__PURE__ */ new Map();
  ...
  self.addEventListener("fetch", (event) => {
    ...
    if (pluginsIndex !== -1 && pathSegments[slugIndex]) {
      ...
      const fileName = pathSegments.length > slugIndex + 1 ? pathSegments[slugIndex + 1].split("?")[0] : "";
  ...
  async function handlePlugin(slug, fileName) {
    ...
    return new Promise((resolve) => {
      ...
      channel.port1.onmessage = (messageEvent) => {
        const responseData = messageEvent.data;
...
//# sourceMappingURL=plugin-sw.js.map
